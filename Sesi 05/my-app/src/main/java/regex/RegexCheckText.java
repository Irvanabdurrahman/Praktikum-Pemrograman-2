...
public class RegexCheckText{
		public static void main(String[] args){
				String text1 = " Matheas Jabs 50092 KA (021) - 28946300 AA SA mjabs@yahoo.com ";
				
				//mencari kata yang terdiri dari huruf A s/d Z atau a s/d z
				//dan panjangnya antara 2 sampai 20 character
				regexChecker("\\w[A-Za-z]{2,20}\\w",text1);
		}
